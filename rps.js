...
function playGame() {
  alert(`You will now play 5 rounds of Rock Paper Scissors against the computer. Press F12 to view the console and see your score. Please pick a hand and select "Okay". Select cancel to stop.`) 
